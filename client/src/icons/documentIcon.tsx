...
export default function DocumentIcon(){
    ...
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="black" strokeWidth="1.5" className="size-5 group-hover:fill-black group-hover:stroke-none" viewBox="0 0 50 50">
